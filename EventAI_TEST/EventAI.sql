...
-- npc_longsnout
UPDATE `creature_template` SET `AIName`='',`ScriptName`='npc_longsnout' WHERE `entry`=119;

DELETE FROM `creature_ai_scripts` WHERE `creature_id`=119;

-- npc_defias_pathstalker
UPDATE `creature_template` SET `AIName`='',`ScriptName`='npc_defias_pathstalker' WHERE `entry`=121;

DELETE FROM `creature_ai_scripts` WHERE `creature_id`=121;

-- npc_defias_highwayman
UPDATE `creature_template` SET `AIName`='',`ScriptName`='npc_defias_highwayman' WHERE `entry`=122;

DELETE FROM `creature_ai_scripts` WHERE `creature_id`=122;
